...
df_OLD = pd.read_excel('emp1.xlsx').fillna(0)
df_NEW = pd.read_excel('emp2.xlsx').fillna(0)
...
df_OLD.to_excel(writer, sheet_name='emp2.xlsx', index=False)
...
# define formats
grey_fmt = workbook.add_format({'font_color': '#000000'})
